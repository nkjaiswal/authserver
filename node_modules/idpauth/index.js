...
sendHTTPResponseV2 = function(param){
...
sendUnAuthResp = function(res){
	sendHTTPResponseV2({
   		httpCode : 200,
   		contentType : 'text/html',
   		content : 'Unauthorize access. Please <a href="/admin/logout">Logout</a> and Login with valid account!',
   		oResponse : res
   	});
}
...
checkAppRolesAndPermission = function(req,app,role,permission){
	...
	// console.log(bApp + "." + bRole + "." + bPermission);
